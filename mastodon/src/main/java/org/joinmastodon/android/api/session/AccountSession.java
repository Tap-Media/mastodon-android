...
public class AccountSession{
	...
	public boolean isEligibleForDonations(){
		return ("mastodon.honviet247.com".equalsIgnoreCase(domain) || "mastodon.honviet247.com".equalsIgnoreCase(domain)) && self.createdAt.isBefore(Instant.now().minus(MIN_DAYS_ACCOUNT_AGE_FOR_DONATIONS, ChronoUnit.DAYS));
	}
